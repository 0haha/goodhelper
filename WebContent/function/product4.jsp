...
<div class="contact">
	<div class="container">
		...
		<h3><a href="fuction3.action">BACK TO REMAKE</a></h3>
...
//out.println(questionareID);

ResultSet rs=stmt.executeQuery("select * "+"from questionare natural join question "+"where questionare_ID="+questionareID+";");
%>
...
case 'r':
	...
	for(int i=0;i<7;i++){
		...
		if(sss!=null){
			...
			out.println("<input type='radio' name='"+questionID+"' value='"+itemArray[i]+"'>");
		}
	}
	out.println("<br/>");
	break;
case 'c':
	...
	for(int i=0;i<7;i++){
		...
		if(sss!=null){
			out.println(itemArray[i]+":"+sss);
			out.println("<input type='checkbox' name='"+questionID+"' value='"+itemArray[i]+"'>");
		}
	}
	out.println("<br/>");
	break;
...
start++;
 String linkPath=(String)session.getAttribute("linkPath");
out.println("The link you need:"+linkPath);%> 
