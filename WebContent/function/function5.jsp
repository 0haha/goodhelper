...
sf.close();
%><br/>
<form action="product5.action">
 Please write down the name of your community:<input type="text" name="nameOfCommunity"></br>
 And Please write down the name of the menber:
 <% //以下需要使用ajax替代
 for(int i=0;i<10;i++){
	 String menbertmp="menber".concat(String.valueOf(i));
	 out.println("<input type='text' name='"+menbertmp+"'><br>");
 }
 %>
