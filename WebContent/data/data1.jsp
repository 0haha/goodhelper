...
InformationList=informationServiceImpl.provideInformation(usename); 
for(Information inftmp:InformationList){
	
	out.print("<h2>"+inftmp.getTitile()+"</h2><h3> The informant who have read:");
	List<String>menbers=inftmp.getIsRead();
