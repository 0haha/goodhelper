...
<div class="contact">
	<div class="container">
		<div class="content_middle_bottom">
		  ...
		  <h4>Just to click your free time!</h4>
		</div>
 ...
 String IDtmp1=request.getQueryString();
 String[] IDtmpArray=IDtmp1.split("=");
 String ID=IDtmpArray[1];
 ...
 out.println("Please write down your name："+"<input type='text' name='name'/><br/><br/>");
